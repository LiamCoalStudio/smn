...
str C_Generator::generate_class_visibility(const str &vis)
unsupported(class_error)
...
str C_Generator::generate_class_end()
{ return generate_struct_end(); }

str C_Generator::generate_interface_start(const str &name)
unsupported(class_error)

str C_Generator::generate_interface_end()
unsupported(class_error)
